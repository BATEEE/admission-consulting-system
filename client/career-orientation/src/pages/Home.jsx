...
const Home = () => {
    ...
    <div className="col-lg-4 col-md-6 mb-4">
      <div className="card h-100 shadow-lg border-0 transition-300 hover-scale-up">
        <div className="card-body p-4">
          ...
          {/* SỬA: Dùng Link to={linkUrl} để điều hướng đúng */}
  ...
  return (
    <main>
      {/* 1. KHU VỰC HERO/QUẢNG CÁO LỚN (CTA Chính) - KHÔNG ĐỔI */}
      <section
      ...
      {/* 3. KHU VỰC TÍNH NĂNG CỐT LÕI (ĐÃ SỬA LINK) */}
